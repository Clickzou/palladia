...
export const hotel = {
  ...
  services: [
    ...
    { nom: "Parking", detail: "Parking de 250 places gratuit, emplacements bornes électriques", icone: "parking" },
    ...
    { nom: "Business center", detail: "Un ordinateur connecté à internet", icone: "business" },
