...
export const tourisme = {
  ...
  lieux: [
    { nom: "Basilique Saint-Sernin", description: "Église romane emblématique de Toulouse, datant du XIe siècle.", adresse: "Place Saint-Sernin – Toulouse" },
    { nom: "Canal du Midi", description: "Location de vélo pour une balade le long du canal du midi.", adresse: "Avenue de l’URSS – Toulouse" },
    { nom: "Cathédrale Saint-Étienne", description: "Cathédrale mêlant styles roman et gothique, siège de l’archevêché.", adresse: "Impasse de la Préfecture – Toulouse" },
    { nom: "Citée de l’Espace", description: "Parc à thème scientifique dédié à l’espace et aux planètes.", adresse: "Av. Jean Gonord – Toulouse" },
    { nom: "Coulée Verte du Touch", description: "Voie verte urbaine de 9,5 km – idéale pour promeneurs et joggeurs.", adresse: "75 Chem. des Capelles – Toulouse" },
    { nom: "Couvent des Jacobins", description: "Chef-d’œuvre de l’art gothique méridional avec cloître paisible.", adresse: "Rue Pargaminières – Toulouse" },
    { nom: "Fondation Bemberg", description: "Magnifique hôtel particulier de la renaissance, abritant un musée.", adresse: "Place d’Assézat – Toulouse" },
    { nom: "Halle de la Machine", description: "Exhibition de machines de spectacles géantes.", adresse: "Aérodrome de Montaudran – Toulouse" },
    { nom: "Jardin Japonais", description: "Jardin zen à la japonaise dans le parc Compans-Caffarelli.", adresse: "Jardin Compans Caffarelli – Toulouse" },
    { nom: "Jardin des Plantes", description: "Grand parc arboré avec volières et muséum.", adresse: "56 rue Alfred Duméril – Toulouse" },
    { nom: "Jardins du Barry", description: "Parc de 8 hectares au milieu d’espaces naturels préservés.", adresse: "1 Rue Ernest Dufer – Toulouse" },
    { nom: "La Halle aux Grains", description: "Salle de concert symphonique et de spectacles culturels.", adresse: "Place Dominique Martin Dupuy – Toulouse" },
    { nom: "La Maison de la Violette", description: "Péniche-musée et boutique sur la violette, fleur de Toulouse.", adresse: "Boulevard de Bonrepos – Toulouse" },
    { nom: "L’Envol des Pionniers", description: "Musée retraçant l’histoire de l’aéropostale et de ses héros.", adresse: "Rue Jacqueline Auriol – Toulouse" },
    { nom: "Les Abattoirs", description: "Musée d’art moderne et contemporain.", adresse: "Allées Charles de Fitte – Toulouse" },
    { nom: "Let’s Visit Airbus", description: "Visite guidée des usines Airbus à Blagnac.", adresse: "All. André Turcat – Blagnac" },
    { nom: "Marché des Carmes", description: "Marché convivial avec stands variés.", adresse: "Place des Carmes – Toulouse" },
    { nom: "Marché Victor Hugo", description: "Grand marché couvert réputé pour ses produits frais.", adresse: "Rue Rivals – Toulouse" },
    { nom: "Musée Aeroscopia", description: "Musée aéronautique avec avions Concorde et Airbus à visiter.", adresse: "Voie Lactée – Blagnac" },
    { nom: "Musée des Augustins", description: "Musée des beaux-arts installé dans un ancien couvent gothique.", adresse: "Rue Antonin Mercié – Toulouse" },
    { nom: "Muséum Histoire Naturelle", description: "Muséum interactif sur la biodiversité, fossiles et animaux.", adresse: "Allées Jules Guesde – Toulouse" },
    { nom: "Musée Georges Labit", description: "Objets asiatiques et égyptiennes dans une villa mauresque.", adresse: "Rue du Japon – Toulouse" },
    { nom: "Musée Saint-Raymond", description: "Musée archéologique avec sculptures romaines et art antique.", adresse: "Place Saint-Sernin – Toulouse" },
    { nom: "Nailloux Outlet Village", description: "Village de marques à 25 min de Toulouse avec réductions.", adresse: "Nailloux" },
    { nom: "Parc du Confluent", description: "Réserve naturelle au sud de Toulouse, parfaite pour les balades.", adresse: "Portet-sur-Garonne" },
    { nom: "Place du Capitole", description: "Place centrale emblématique entourée de cafés et commerces.", adresse: "Place du Capitole – Toulouse" },
    { nom: "Place Saint-Pierre", description: "Place animée au bord de la Garonne, connue pour sa vie nocturne.", adresse: "Place Saint-Pierre – Toulouse" },
    { nom: "Pont Neuf", description: "Pont historique en brique traversant la Garonne, datant du XVIIe siècle.", adresse: "1 place Laganne – Toulouse" },
    { nom: "Quai de la Daurade", description: "Promenade agréable le long de la Garonne avec vue sur la ville.", adresse: "Quai de la Daurade – Toulouse" },
    { nom: "Théâtre Garonne", description: "Spectacles de danse, théâtre, musique, et artistes du monde.", adresse: "Avenue du Château d’Eau – Toulouse" },
    { nom: "Wam Park Toulouse", description: "Parc de loisirs nautiques sur le lac de Sesquières.", adresse: "Lac de Sesquière – Toulouse" },
    { nom: "Zénith de Toulouse", description: "Grande salle de concert et spectacles près du Palladia.", adresse: "Avenue de Grande Bretagne – Toulouse" },
  ],
