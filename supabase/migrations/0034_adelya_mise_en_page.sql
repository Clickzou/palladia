-- ---------------------------------------------------------------------------
-- Article « Carte de fidélité Adelya » : mise en page reprise du site.
--
-- 0032 avait decoupe en trop de blocs. Sur le site, chaque section tient en
-- une seule rangee : le visuel d'un cote, et de l'autre TOUT le texte —
-- paragraphes, sous-titres, sous-sections et bouton compris.
--
-- Les fonds sont egalement corriges : « Comment ça fonctionne ? » est sur
-- fond blanc, seule la rangee « Qui peut en bénéficier ? » est grisee.
--
...
(values
  -- Logo a gauche ; a droite, la presentation entiere jusqu'au bouton
  (0, 'texte_image', '{
    "position": "gauche",
    ...
    "sections": [
      {
        "titre": "Qu’est-ce que la carte de fidélité Adelya ?",
        "intro": "La carte de fidélité Adelya est une **carte digitale gratuite** qui vous permet de cumuler des points à chaque passage à l’Hôtel Palladia. Ces points sont ensuite convertibles en **réductions, cadeaux ou services offerts**.",
  ...
  -- Les trois etapes, sur fond blanc
  (1, 'sections', '{
  ...
  -- Photo bord a bord a gauche ; a droite, les cinq avantages
  (2, 'texte_image', '{
    "pleine_largeur": true,
    "position": "gauche",
  ...
  -- Seule rangee grisee : deux colonnes
  (3, 'sections', '{
    "fond_gris": true,
    "deux_colonnes": true,
    "sections": [
